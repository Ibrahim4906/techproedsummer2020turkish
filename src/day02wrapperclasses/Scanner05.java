...
public class Scanner05 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("Lutfen bir yaricap (radius) sayisi giriniz.");
		
		double radius = scan.nextDouble();// Data tipi int ise netxInt() kullanilabilir.
										  // Data tipi double ise nextDouble() kullanilir.
		System.out.println(3.14159 * radius * radius);
		
		System.out.println(2 * 3.1459 * radius);
