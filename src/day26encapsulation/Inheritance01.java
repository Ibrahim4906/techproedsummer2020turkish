...
public class Inheritance01 {
	...
	public static void main(String[] args) {
		// Inheritance miras demektir. Iki Class arasinda Parent - Child iliskisi var 
		// ise inheritance'dan bahsedilebilir.
		
		// 1)Inheritance public ve protected data'lar icin problemsiz calisir.
		// 2)bahsedilebilir.Inheritance default data'lar icin child ile parent ayni package'da ise
		// calisir. 
